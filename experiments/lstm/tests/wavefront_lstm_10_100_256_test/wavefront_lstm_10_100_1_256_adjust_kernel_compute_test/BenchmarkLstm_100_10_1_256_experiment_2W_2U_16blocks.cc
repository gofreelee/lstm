...
#include "net/lstm_100_10_experiment/LSTM100_10_2W_2U_16blocksExperiment.h"
...
int main(int argc, char *argv[]) {
    ...
    std::shared_ptr<LSTM100_10Experiment> impl(new LSTM100_10_2W_2U_16blocksExperiment());
    int nDevices;
