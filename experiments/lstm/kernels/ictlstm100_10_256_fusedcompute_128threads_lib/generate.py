    ...
    for i in range(110):
        ...
        if i <= 9:
            ...
            for m in range(i + 1):
                ...
                str(m) + ", " +
                str(i - m) + "* LstmScaleParams::kCellNumber10 + " + str(m) +", " +
                "LstmScaleParams::kColumsPerBlock32, LstmScaleParams::kHiddenSize256, LstmScaleParams::kInputSize256, LstmScaleParams::kThreadNumPerBlock128, LstmScaleParams::kMask7);")
                fd.writelines("break;")
            fd.write("}\n")
            fd.write("}")
