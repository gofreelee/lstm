...
// #include "WavefrontParams.h"
#include <cstddef>
#include <vector>

namespace mica::experiments::lstm {
class LSTM100_20Experiment {
  protected:
    /* data */
  ...
  public:
    LSTM100_20Experiment()
        : num_step(lstm_100_10_num_step), num_layer(20),
          hidden_size(lstm_100_10_hidden_size),
          batch_size(lstm_100_10_batch_size) {}
    LSTM100_20Experiment(size_t num_step_, size_t num_layer_)
