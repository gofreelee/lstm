def genarate_function_call():
    ...
    for i in range(109):
        ...
        if i >= 10 and i <= 99:
            fd.write("cudaLaunchKernel((void *)wave_compute_" + str(i) + ", dim3(160), dim3(256), (void **)arg_s, 0,stream);\n")
            fd.write("cudaLaunchKernel((void *)wave_solve_" + str(i) + ", dim3(80), dim3(256), (void **)arg_s, 0,stream);\n")
        if i >99 and i < 109:
            fd.write("cudaLaunchKernel((void *)wave_compute_" + str(i) + ", dim3("+ str(16 * (109 - i)) +"), dim3(256), (void **)arg_s, 0,stream);\n")
...
def generate_waves_2W_2U_16blocks():
    for i in range(109):
